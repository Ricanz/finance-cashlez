        ...
        <div class="card card-flush px-10 py-6 rounded-sm">
            ...
            <div class="d-flex flex-wrap justify-content-between">
                ...
                <div class="d-flex flex-wrap">
                    <div class="border border-gray-300 border-dashed rounded  w-300px py-3 px-4 me-6 mb-3">
                        <a href={{ isset($token_applicant) ? url('/reconcile/'.$token_applicant.'/show?status=match') : url('/reconcile/show?status=match') }} class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                            <!--begin::Hidden-->
                    ...
                    <div class="border border-gray-300 border-dashed rounded  w-300px py-3 px-4 me-6 mb-3">
                        <a href={{ isset($token_applicant) ? url('/reconcile/'.$token_applicant.'/show?status=dispute') : url('/reconcile/show?status=dispute') }} class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                            <!--begin::Hidden-->
                            <div class="d-flex flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                <div class="me-2">
                    ...
                    <div class="border border-gray-300 border-dashed rounded  w-300px py-3 px-4 me-6 mb-3">
                        <a href={{ isset($token_applicant) ? url('/reconcile/'.$token_applicant.'/show?status=onHold') : url('/reconcile/show?status=onHold') }} class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                            <!--begin::Hidden-->
                            <div class="d-flex flex-stack flex-wrap flex-grow-1 px-2 pt-2 pb-3">
                                <div class="me-2">
            ...
            <div class="d-flex flex-stack mb-5">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    <!--begin::Filter-->
                    <a href="{{ isset($token_applicant) ? url('/reconcile/'.$token_applicant.'/download') : url('/reconcile/download') }} " class="btn btn-light-warning me-3 rounded-sm">Download</a>
                    <!--end::Filter-->
                </div>
                <!--end::Toolbar-->
