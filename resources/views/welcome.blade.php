                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="{{ asset('cztemp/assets/media/avatars/150-11.jpg')}}" alt="" />
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="{{ asset('cztemp/assets/media/avatars/150-3.jpg')}}" alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="{{ asset('cztemp/assets/media/avatars/150-4.jpg')}}" alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="{{ asset('cztemp/assets/media/avatars/150-5.jpg')}}" alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="{{ asset('cztemp/assets/media/avatars/150-6.jpg')}}" alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                    ...
                    <div class="card-body pt-2">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <img src="{{ asset('cztemp/assets/media/avatars/150-1.jpg')}}" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5">
                                <img src="{{ asset('cztemp/assets/media/avatars/150-4.jpg')}}" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5">
                                <img src="{{ asset('cztemp/assets/media/avatars/150-12.jpg')}}" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5">
                                <img src="{{ asset('cztemp/assets/media/avatars/150-8.jpg')}}" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5">
                                <img src="{{ asset('cztemp/assets/media/avatars/150-6.jpg')}}" class="" alt="" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Text-->
                            <div class="flex-grow-1">
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="{{ asset('cztemp/assets/media/svg/brand-logos/plurk.svg')}}" class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                            <!--begin::Section-->
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="{{ asset('cztemp/assets/media/svg/brand-logos/telegram.svg')}}" class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                            <!--begin::Section-->
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="{{ asset('cztemp/assets/media/svg/brand-logos/vimeo.svg')}}" class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                            <!--begin::Section-->
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="{{ asset('cztemp/assets/media/svg/brand-logos/bebo.svg')}}" class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                            <!--begin::Section-->
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label">
                                    <img src="{{ asset('cztemp/assets/media/svg/brand-logos/kickstarter.svg')}}" class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <!--end::Symbol-->
                            <!--begin::Section-->
                        ...
                        <div class="mt-5">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <div class="symbol symbol-50px me-3">
                                        <div class="symbol-label bg-light">
                                            <img src="{{ asset('cztemp/assets/media/svg/brand-logos/plurk.svg')}}" class="h-50" alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                            ...
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <div class="symbol symbol-50px me-3">
                                        <div class="symbol-label bg-light">
                                            <img src="{{ asset('cztemp/assets/media/svg/brand-logos/figma-1.svg')}}" class="h-50" alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <div class="symbol symbol-50px me-3">
                                        <div class="symbol-label bg-light">
                                            <img src="{{ asset('cztemp/assets/media/svg/brand-logos/vimeo.svg')}}" class="h-50" alt="" />
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
